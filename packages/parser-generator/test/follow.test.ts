...
import { NIL, EOF } from "@light0x00/parser-definition";
import { NonTerminal, SimpleGrammar } from "@/Definition";
...
describe("============The calculation of follow set============", function () {
	...
	describe("1. 后跟终结符", function () {
		...
		let calculator = new FollowSetCalculator(grammar,new FirstSetCalculator(grammar));
