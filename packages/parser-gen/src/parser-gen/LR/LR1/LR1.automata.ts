import { NIL as Nil, EOF } from "@/common/definition";
import { Production, NonTerminal, Symbol, Terminal, } from "../../definition";
import { ItemSet, State, Item, AugmentedGrammar, AutomataTools } from "../LRDefinition";
import { addAll_Set, IFunction } from "@/common/shim";
import { getStateSet } from "../LRStateAutomata";
...
2.如何展开(LR展望符集计算)
    ...
    2.1. 针对闭包项
        2.1.1 展开符包含左递归产生式,初始状态I0中项S->·E产生如下3个闭包项:
			...
			在本例中,E->·E+F的「左递归兄弟项」是 E->·E*F,这个兄弟项的「最左非左递归符号」是`*`, 且E->·E+F继承了`$`.
